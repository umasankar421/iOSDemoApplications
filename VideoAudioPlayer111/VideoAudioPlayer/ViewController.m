...
//    //NSURL *videoUrl = [NSURL fileURLWithPath:@"pk.mp4"];
...
//    
//    NSLog(@"path : %@ and audio path : %@",videoURL.absoluteString,audioURL.absoluteString);
//    // create an AVPlayer
...
//    playerViewController.view.frame = CGRectMake(0, 100, self.view.frame.size.width, self.view.frame.size.height-100);
