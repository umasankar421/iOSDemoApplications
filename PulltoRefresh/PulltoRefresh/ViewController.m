...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *rightButton = [[UIBarButtonItem alloc]initWithTitle:@"Scroll to Down" style:UIBarButtonItemStyleDone target:self action:@selector(scrolltoDown:)];
